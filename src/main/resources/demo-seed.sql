...
-- ============================================================
INSERT INTO trips (trip_date, bus_id, driver_id, conductor_id, status, dispatch_time, arrival_time, trip_count, remarks, created_by)
SELECT * FROM (SELECT
  '2026-05-28' d, b.id bi, drv.id di, con.id ci, 'FINISHED' s, '05:30:00' dsp, '22:15:00' arr, 7  tc, NULL rm, 2 cb FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-05-28', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 6,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-05-28', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 6,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0003' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
SELECT '2026-05-29', b.id, drv.id, con.id, 'FINISHED', '05:00:00', '22:30:00', 8,  'Updated trip count after field review', 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-05-29', b.id, drv.id, con.id, 'FINISHED', '05:00:00', '22:15:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-05-29', b.id, drv.id, con.id, 'FINISHED', '05:00:00', '22:00:00', 7,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0003' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
SELECT '2026-05-30', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:00:00', 5,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-05-30', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '20:45:00', 5,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-05-30', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '20:30:00', 4,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0003' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
SELECT '2026-05-31', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:30:00', 6,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-05-31', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:00:00', 4,  'Low income — holiday eve traffic',      2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-01', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 8,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-01', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-01', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:30:00', 6,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
SELECT '2026-06-02', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-02', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 6,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-02', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:30:00', 6,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
SELECT '2026-06-03', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 7,  'Income corrected after recount',        2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-03', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:30:00', 6,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
-- June 4
SELECT '2026-06-04', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:15:00', 8,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-04', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-04', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:15:00', 8,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
-- June 5
SELECT '2026-06-05', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-05', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '20:30:00', 5,  'Low income — heavy rain all day',       2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-05', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 7,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
-- June 6 (Saturday — reduced service)
SELECT '2026-06-06', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:30:00', 6,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-06', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:00:00', 5,  'Low income — Saturday',                 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
-- June 7 (Sunday — minimal service)
SELECT '2026-06-07', b.id, drv.id, con.id, 'FINISHED', '06:00:00', '20:00:00', 4,  'Low income — Sunday reduced service',   2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-07', b.id, drv.id, con.id, 'FINISHED', '06:00:00', '20:30:00', 5,  'Low income — Sunday',                   3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
-- June 8
SELECT '2026-06-08', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:15:00', 8,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-08', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-08', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:00:00', 8,  'Expenses corrected by admin',           3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
-- June 9 (today)
SELECT '2026-06-09', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0001' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-09', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:30:00', 6,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-09', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 7,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
-- June 10 (Bus 0001 out of service; its crew reassigned to Bus 0003)
SELECT '2026-06-10', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '21:45:00', 7,  NULL, 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-10', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:15:00', 7,  'Trip count corrected after dispatcher recount', 2 FROM buses b, employees drv, employees con WHERE b.bus_number='0003' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001' UNION ALL
SELECT '2026-06-10', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '22:15:00', 8,  NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0004' AND drv.employee_code='DRV-003' AND con.employee_code='CON-003' UNION ALL
-- June 11 (today)
SELECT '2026-06-11', b.id, drv.id, con.id, 'FINISHED', '05:30:00', '11:30:00', 3,  'Low income — early return for mechanical inspection', 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0002' AND drv.employee_code='DRV-002' AND con.employee_code='CON-002' UNION ALL
SELECT '2026-06-11', b.id, drv.id, con.id, 'SCHEDULED', '05:30:00', NULL,        NULL, NULL, 3 FROM buses b, employees drv, employees con WHERE b.bus_number='0003' AND drv.employee_code='DRV-001' AND con.employee_code='CON-001'
) AS src
